...
//
//   async getPopularPosts(): Promise<[...typeof DUMMY_POSTS]> {
...
//       user: {
//         id: post.user.id,
//         name: post.user.profile?.profileName ?? "",
//         image: post.user.profile?.profileImgUrl ?? "",
//       },
//     }));
//   }
//
//   async getFollowerPosts(id: User["id"]): Promise<[...typeof DUMMY_POSTS]> {
//     const followers = await this.prisma.users
//       .findUnique({
//         where: {
//           id,
//         },
...
//         },
//       })
//       .then((user) => user!.followers.map((follower) => follower.id));
//
//     const posts = await this.prisma.post.findMany({
//       where: {
//         authorId: {
...
//
//   makeTestData(): Promise<void> {
//     this.prisma.users.createMany({
//       data: [
//         {
//           id: "1",
//           email: "test1@until.com",
//         },
//         {
//           id: "2",
//           email: "test2@until.com",
//         },
//       ],
//     });
...
//           urlSlug: "nextjspost",
//           authorId: "1",
//           body: "Next.js 10 is out! Next.js 10 is out! Next.js 10 is out!",
//         },
//         {
//           id: "2",
...
//           body: "Learn the basics of TypeScript in this introductory guide.",
//           authorId: "2",
//           urlSlug: "introduce-typescript",
//         },
//         {
//           id: "3",
...
//           body: "Discover how to create a RESTful API using Express.js framework.",
//           authorId: "3",
//           urlSlug: "building-restful-api-expressjs",
//         },
//       ],
//     });
//
...
//           name: "nextjs",
//           description:
//             "Next.js는 리액트 애플리케이션을 만들기 위한 프레임워크입니다.",
//         },
//         {
//           id: "2",
//           name: "react",
//           description: "React는 페이스북에서 만든 프론트엔드 라이브러리입니다.",
//         },
//         {
//           id: "3",
//           name: "javascript",
//           description: "자바스크립트는 웹을 위한 프로그래밍 언어입니다.",
//         },
//       ],
//     });
//
